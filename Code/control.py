...
for record in records:
	...
	if len(record.seq) > len(count): #Print the result only if the length of the total sequence is larger than the whole assembly, which is true given that the reference includes the d-loop
